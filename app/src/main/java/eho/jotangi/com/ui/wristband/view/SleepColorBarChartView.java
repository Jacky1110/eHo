 ...
 *  色條平均分配View的寬度
 */
public class SleepColorBarChartView extends View {
    ...
    public SleepColorBarChartView(Context context) {
        super(context);
        init();
    }

    public SleepColorBarChartView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SleepColorBarChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public SleepColorBarChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
